...
if(NOT DEFINED COMMON_CLANG_LIBRARY_NAME)
  set(COMMON_CLANG_LIBRARY_NAME opencl-clang2)
endif()

set(COMMON_CLANG_LIB_FULL_NAME "lib${COMMON_CLANG_LIBRARY_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}")

set(CCLANG_SYSTEM_SEARCH_NAMES)



foreach(clang_so_version RANGE 14 99)
  list(APPEND CCLANG_SYSTEM_SEARCH_NAMES "${COMMON_CLANG_LIB_FULL_NAME}.${clang_so_version}")
endforeach()

find_library(CCLANG_FROM_SYSTEM NAMES ${CCLANG_SYSTEM_SEARCH_NAMES})
...
if(CCLANG_FROM_SYSTEM)
  ...
  find_library(SYSTEM_COMMON_CLANG NAMES ${CCLANG_SYSTEM_SEARCH_NAMES})
