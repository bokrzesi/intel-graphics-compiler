...
set(CCLANG_SYSTEM_SEARCH_PATHS "${COMMON_CLANG_LIBRARY_NAME}" "${COMMON_CLANG_LIB_FULL_NAME}.14")

find_library(CCLANG_FROM_SYSTEM NAMES ${CCLANG_SYSTEM_SEARCH_PATHS})
...
if(CCLANG_FROM_SYSTEM)
  ...
  find_library(SYSTEM_COMMON_CLANG NAMES ${CCLANG_SYSTEM_SEARCH_PATHS})
