...
using llvm::raw_ostream;
  ...
  #define OPTION(PREFIX, NAME, ID, KIND, GROUP, ALIAS, ALIASARGS, FLAGS, VISIBILITY, PARAM,                             \
          HELPTEXT, HELPTEXTSFORVARIANTS, METAVAR, VALUES, SUBCOMMANDIDS_OFFSET)                                        \
    {PREFIX, NAME,  HELPTEXT, HELPTEXTSFORVARIANTS, METAVAR, api::OPT_##ID, Option::KIND##Class,                        \
    PARAM, FLAGS, VISIBILITY, api::OPT_##GROUP, api::OPT_##ALIAS, ALIASARGS, VALUES, SUBCOMMANDIDS_OFFSET},
  #include "igc/Options/ApiOptions.inc"
  #undef OPTION
  };
#else
...
public:
#if LLVM_VERSION_MAJOR >= 22
  IGCApiOptTable() : IGCLLVM::GenericOptTable(OptionStrTable, OptionPrefixesTable, ApiInfoTable) {
#else
