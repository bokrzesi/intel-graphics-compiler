...
static const MangleSubstTy MangleSubst = {{"11ocl_image1d", "14ocl_image1d"},
...
static std::unordered_map<std::string, std::string> MangleStr = {
    ...
    {"28IGIL_EnqueueKernelWithEvents9ocl_queuejPvjS_S_jS_jiPi9ndrange_tiiPKU3AS412ocl_clkeventPU3AS412ocl_"
     "clkevent12ocl_clkevent",
    ...
    {"11read_imagef14ocl_image2d_ro11ocl_samplerDv2_fS_S_", "11read_imagef14ocl_image2d_ro11ocl_samplerDv2_fS1_S1"},
    {"11read_imagei14ocl_image2d_ro11ocl_samplerDv2_fS_S_", "11read_imagei14ocl_image2d_ro11ocl_samplerDv2_fS1_S1_"},
    {"12read_imageui14ocl_image2d_ro11ocl_samplerDv2_fS_S_", "12read_imageui14ocl_image2d_ro11ocl_samplerDv2_fS1_S1_"},
    ...
    {"11read_imagef14ocl_image3d_ro11ocl_samplerDv4_fS_S_", "11read_imagef14ocl_image3d_ro11ocl_samplerDv4_fS1_S1_"},
    {"11read_imagei14ocl_image3d_ro11ocl_samplerDv4_fS_S_", "11read_imagei14ocl_image3d_ro11ocl_samplerDv4_fS1_S1_"},
    {"12read_imageui14ocl_image3d_ro11ocl_samplerDv4_fS_S_", "12read_imageui14ocl_image3d_ro11ocl_samplerDv4_fS1_S1_"},
    ...
    {"41intel_work_group_vme_mb_multi_check_16x16PU3AS3jjjjDv2_ii14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler",
     "41intel_work_group_vme_mb_multi_check_16x16PU3AS3jjjjDv2_ii14ocl_image2d_roS2_S2_11ocl_sampler"},
    {"39intel_work_group_vme_mb_multi_check_8x8PU3AS3jjjjDv2_iDv4_i14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_"
     "ro11ocl_sampler",
     "39intel_work_group_vme_mb_multi_check_8x8PU3AS3jjjjDv2_iDv4_i14ocl_image2d_roS3_S3_11ocl_sampler"},
    {"47intel_work_group_vme_mb_multi_bidir_check_16x16PU3AS3jjjjDv2_ihhi14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_"
     "ro14ocl_image2d_ro11ocl_sampler",
     "47intel_work_group_vme_mb_multi_bidir_check_16x16PU3AS3jjjjDv2_ihhi14ocl_image2d_roS2_S2_S2_11ocl_sampler"},
    {"45intel_work_group_vme_mb_multi_bidir_check_8x8PU3AS3jjjjDv2_ihhS1_14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_"
     "ro14ocl_image2d_ro11ocl_sampler",
     "45intel_work_group_vme_mb_multi_bidir_check_8x8PU3AS3jjjjDv2_ihhS1_14ocl_image2d_roS2_S2_S2_11ocl_sampler"},
    {"52intel_sub_group_avc_ime_evaluate_with_dual_reference14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler33intel_sub_group_avc_ime_payload_t",
     "52intel_sub_group_avc_ime_evaluate_with_dual_reference14ocl_image2d_roS_S_11ocl_sampler33intel_sub_group_avc_ime_"
     "payload_t"},
    {"54intel_sub_group_avc_ime_evaluate_with_single_reference14ocl_image2d_ro14ocl_image2d_ro11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t",
     "54intel_sub_group_avc_ime_evaluate_with_single_reference14ocl_image2d_roS_11ocl_sampler33intel_sub_group_avc_ime_"
     "payload_t"},
    {"64intel_sub_group_avc_ime_evaluate_with_single_reference_streamout14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler33intel_sub_group_avc_ime_payload_t",
     "64intel_sub_group_avc_ime_evaluate_with_single_reference_streamout14ocl_image2d_roS_11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t"},
    {"62intel_sub_group_avc_ime_evaluate_with_dual_reference_streamout14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_"
     "ro11ocl_sampler33intel_sub_group_avc_ime_payload_t",
     "62intel_sub_group_avc_ime_evaluate_with_dual_reference_streamout14ocl_image2d_roS_S_11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t"},
    {"63intel_sub_group_avc_ime_evaluate_with_single_reference_streamin14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler33intel_sub_group_avc_ime_payload_t51intel_sub_group_avc_ime_single_reference_streamin_t",
     "63intel_sub_group_avc_ime_evaluate_with_single_reference_streamin14ocl_image2d_roS_11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t51intel_sub_group_avc_ime_single_reference_streamin_t"},
    {"61intel_sub_group_avc_ime_evaluate_with_dual_reference_streamin14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_"
     "ro11ocl_sampler33intel_sub_group_avc_ime_payload_t49intel_sub_group_avc_ime_dual_reference_streamin_t",
     "61intel_sub_group_avc_ime_evaluate_with_dual_reference_streamin14ocl_image2d_roS_S_11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t49intel_sub_group_avc_ime_dual_reference_streamin_t"},
    {"66intel_sub_group_avc_ime_evaluate_with_single_reference_streaminout14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler33intel_sub_group_avc_ime_payload_t51intel_sub_group_avc_ime_single_reference_streamin_t",
     "66intel_sub_group_avc_ime_evaluate_with_single_reference_streaminout14ocl_image2d_roS_11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t51intel_sub_group_avc_ime_single_reference_streamin_t"},
    {"64intel_sub_group_avc_ime_evaluate_with_dual_reference_streaminout14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_"
     "ro11ocl_sampler33intel_sub_group_avc_ime_payload_t49intel_sub_group_avc_ime_dual_reference_streamin_t",
     "64intel_sub_group_avc_ime_evaluate_with_dual_reference_streaminout14ocl_image2d_roS_S_11ocl_sampler33intel_sub_"
     "group_avc_ime_payload_t49intel_sub_group_avc_ime_dual_reference_streamin_t"},
    {"52intel_sub_group_avc_ref_evaluate_with_dual_reference14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler33intel_sub_group_avc_ref_payload_t",
     "52intel_sub_group_avc_ref_evaluate_with_dual_reference14ocl_image2d_roS_S_11ocl_sampler33intel_sub_group_avc_ref_"
     "payload_t"},
    {"54intel_sub_group_avc_ref_evaluate_with_single_reference14ocl_image2d_ro14ocl_image2d_ro11ocl_sampler33intel_sub_"
     "group_avc_ref_payload_t",
     "54intel_sub_group_avc_ref_evaluate_with_single_reference14ocl_image2d_roS_11ocl_sampler33intel_sub_group_avc_ref_"
     "payload_t"},
    {"54intel_sub_group_avc_sic_evaluate_with_single_reference14ocl_image2d_ro14ocl_image2d_ro11ocl_sampler33intel_sub_"
     "group_avc_sic_payload_t",
     "54intel_sub_group_avc_sic_evaluate_with_single_reference14ocl_image2d_roS_11ocl_sampler33intel_sub_group_avc_sic_"
     "payload_t"},
    {"52intel_sub_group_avc_sic_evaluate_with_dual_reference14ocl_image2d_ro14ocl_image2d_ro14ocl_image2d_ro11ocl_"
     "sampler33intel_sub_group_avc_sic_payload_t",
     "52intel_sub_group_avc_sic_evaluate_with_dual_reference14ocl_image2d_roS_S_11ocl_sampler33intel_sub_group_avc_sic_"
     "payload_t"}};
  ...
  for (uint i = 0; i < FuncName.size(); i++) {
    if (FuncName[i] == letter) {
      if (FuncName.substr(i + 3, 2) == "AS") {
        new38FuncName = FuncName.slice(0, i).str() + FuncName.slice(i + 1, i + 6).str() + letter;
        i += 5;
        continue;
      }
    }
...
static bool materialized_use_empty(const Value *v) { return v->materialized_use_begin() == v->use_end(); }
...
void BIImport::WriteElfHeaderToMap(DenseMap<StringRef, int> &Map, char *pData, size_t dataSize) {
  ...
  for (uint i = 0; i < dataSize;) {
    ...
    unsigned short func_index =
        (unsigned short)pData2[i + 2 + str_size] | ((unsigned short)pData2[i + 3 + str_size] << 8);
    Map[key] = func_index;
    i += (4 + str_size);
  }
}
...
std::unique_ptr<llvm::Module> BIImport::Construct(Module &M, CLElfLib::CElfReader *pElfReader, bool hasSizet) {
  ...
  std::function<void(Function *)> Explore = [&](Function *pRoot) {
    ...
    for (auto *pCallee : calledFuncs) {
      ...
      if (pCallee->isDeclaration()) {
        ...
        if (funcName.str() == "__enqueue_kernel_basic" || funcName.str() == "__enqueue_kernel_vaargs" ||
            funcName.str() == "__enqueue_kernel_events_vaargs" || funcName.str() == "_Z14enqueue_kernel") {
          funcName = StringRef("enqueue_IB_kernel");
        }
        int SectionIndex = Map[funcName];
        if (SectionIndex == 0 || pCallee->isIntrinsic())
          continue;
        if (elf_index[SectionIndex] == NULL) {
          ...
          std::unique_ptr<MemoryBuffer> OutputBuffer =
              MemoryBuffer::getMemBufferCopy(StringRef(pData_Func, SectionSize));
  ...
  for (auto &global_iterator : BIM->globals()) {
    if (!global_iterator.hasInitializer() && !global_iterator.use_empty()) {
      ...
      size_t SectionSize = 0;
      pElfReader->GetSectionData(SectionIndex, pData_Func, SectionSize);
      std::unique_ptr<MemoryBuffer> OutputBuffer = MemoryBuffer::getMemBufferCopy(StringRef(pData_Func, SectionSize));
      llvm::Expected<std::unique_ptr<llvm::Module>> ModuleOrErr =
          getOwningLazyBitcodeModule(std::move(OutputBuffer), M.getContext());
      if (llvm::Error EC = ModuleOrErr.takeError()) {
  ...
  for (auto &F : M) {
    ...
    for (inst_iterator I = inst_begin(F), E = inst_end(F); I != E; ++I) {
      ...
      if (!BitCastI || !BitCastI->getType()->isPointerTy() ||
          BitCastI->getSrcTy()->getPointerAddressSpace() == BitCastI->getType()->getPointerAddressSpace())
        continue;
    ...
    for (BitCastInst *BitCastI : Worklist) {
      PointerType *SrcPtrType = dyn_cast<PointerType>(BitCastI->getSrcTy());
    ...
    // Handles the function pointer SIMD variant functions
      ...
      for (auto user : F.users()) {
        if (CallInst *CI = dyn_cast<CallInst>(&*user)) {
          ...
          // Parse the variant string, and create a function declaration that represents a variant of the called
          // function.
...
static bool needsPointerASFix(const CallInst *inst, const Function *callee) {
  ...
  if (callFTy->getReturnType()->isPointerTy() && fProtoTy->getReturnType()->isPointerTy() &&
      callFTy->getReturnType()->getPointerAddressSpace() != fProtoTy->getReturnType()->getPointerAddressSpace())
    return true;
  ...
  for (unsigned i = 0, e = callFTy->getNumParams(); i != e; ++i) {
    ...
    if (callTy->isPointerTy() && protoTy->isPointerTy() &&
        callTy->getPointerAddressSpace() != protoTy->getPointerAddressSpace())
      return true;
  }
  return false;
}
  ...
  for (Function &func : M) {
    for (auto &BB : func) {
      for (auto I = BB.begin(), E = BB.end(); I != E; I++) {
        ...
        if (notExists) {
          pDstFunc = Function::Create(pInstCall->getFunctionType(), funcToBeChanged->getLinkage(),
...
bool PreBIImportAnalysis::runOnModule(Module &M) {
  ...
  for (Module::iterator I = M.begin(), E = M.end(); I != E; ++I) {
    ...
    bool isFuncNameToSearch = (funcName == OCL_GET_GLOBAL_OFFSET || funcName == OCL_GET_LOCAL_ID ||
    ...
    if (isFuncNameToSearch) {
      ...
      for (auto f : visited) {
        if (pMdUtil->findFunctionsInfoItem(f) != pMdUtil->end_FunctionsInfo()) {
          ...
          if (funcName == OCL_GET_GLOBAL_OFFSET) {
          ...
          } else if (funcName == OCL_GET_SUBGROUP_ID_IGC_SPVIR || funcName == OCL_GET_SUBGROUP_ID_KHR_SPVIR ||
            ...
            if (modMD->FuncMD[f].workGroupWalkOrder.dim0 == 0 && modMD->FuncMD[f].workGroupWalkOrder.dim1 == 0 &&
    ...
    if ((modMD->compOpt.MatchSinCosPi) && !(modMD->compOpt.FastRelaxedMath) &&
      ...
      for (auto Users : pFunc->users()) {
        if (auto CI = dyn_cast<CallInst>(Users)) {
          ...
          if (isCandidate) {
            unsigned srcPos = 0;
            ConstantFP *fmulConstant = dyn_cast<ConstantFP>(fmulInst->getOperand(0));
    ...
    // SPIRV-Translator:
    // https://github.com/KhronosGroup/SPIRV-LLVM-Translator/blob/main/lib/SPIRV/runtime/OpenCL/inc/spirv_convert.h
    //
    ...
    if (funcName.contains(sConvert) || funcName.contains(uConvert) || funcName.contains(satConvertUToS) ||
        funcName.contains(satConvertSToU)) {
  ...
  for (const auto &InstTuple : InstToModify) {
    ...
    inst->setOperand(srcPos, ConstantFP::get(Type::getFloatTy(inst->getContext()), (float)value));
  }
