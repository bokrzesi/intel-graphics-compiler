    ...
    */
    ...
    if (!I.getType()->isVectorTy() && I.getType()->isPointerTy()) {
      ...
      if (quotient > 1) {
        ...
        Value *newUpBitCast =
            m_builder->CreateBitCast(I.getOperand(0), PointerType::get(I.getContext(), I.getType()->getPointerAddressSpace()));
...
void PeepholeTypeLegalizer::cleanupZExtInst(Instruction &I) {
  ...
  case Instruction::Load: {
    ...
    auto ptrTy = PointerType::get(I.getContext(), Load->getPointerAddressSpace());
